...
// ╠══════╬══════╬══════╬══════╬══════╬══════╬══════╗          ╔══════╦══════╬══════╬══════╬══════╬══════╬══════╣
// ║ LCTL ║  Z   ║  X   ║  C   ║  V   ║  B   ║  <   ║          ║ DEL  ║  N   ║  M   ║  ,   ║  .   ║  -   ║ ENT  ║
// ╚══════╩══════╬══════╬══════╬══════╬══════╩══════╝          ╚══════╩══════╬══════╬══════╬══════╬══════╩══════╝
//        ║ LALT ║ LGUI ║ LWR  ║ SPC  ║                                      ║ BSPC ║ RSE  ║ RALT ║ APP  ║
//        ╚══════╩══════╩══════╩══════╝                                      ╚══════╩══════╩══════╩══════╝
...
// RAISE  ( ~~ = TILDE macro,  § = KC_TILD,  VOL± = VOL_TOGGLE (Shift = down) )
// ╔══════╦══════╦══════╦══════╦══════╦══════╗                       ╔══════╦══════╦══════╦══════╦══════╦══════╗
// ║      ║      ║      ║      ║      ║      ║                       ║  |   ║  ¨   ║  '   ║  \   ║  +   ║ VOL± ║
// ╠══════╬══════╬══════╬══════╬══════╬══════╣                       ╠══════╬══════╬══════╬══════╬══════╬══════╣
// ║      ║      ║      ║      ║      ║      ║                       ║  ~~  ║      ║      ║      ║ HOME ║ PGUP ║
...
// ADJUST  ( CMON = CODEMON,  SCMN = SOFT_CMON,  WS↑/← = Ctrl+Win+arrow (workspace) )
// ╔══════╦══════╦══════╦══════╦══════╦══════╗                          ╔══════╦══════╦══════╦══════╦══════╦══════╗
// ║CYCLE ║ CMON ║ SCMN ║      ║      ║      ║                          ║PRINT ║  ../ ║-${}- ║{...} ║      ║ MUTE ║
// ╠══════╬══════╬══════╬══════╬══════╬══════╣                          ╠══════╬══════╬══════╬══════╬══════╬══════╣
// ║RAISE ║      ║      ║      ║      ║      ║                          ║      ║      ║      ║      ║      ║      ║
// ╠══════╬══════╬══════╬══════╬══════╬══════╣                          ╠══════╬══════╬══════╬══════╬══════╬══════╣
// ║QWERT ║      ║      ║ WS↑  ║      ║      ║                          ║      ║      ║      ║      ║      ║      ║
...
[_ADJUST] = LAYOUT(
  LAYER_CYCLE, CODEMON, SOFT_CMON,           _______,             _______,              _______,                         KC_PSCR, DOT_DOT_SLASH, TEMPLATE, SPREAD,  _______, KC_KB_MUTE,
